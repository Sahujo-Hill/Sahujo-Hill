...
- 🐦‍🔥 **Learning** to integrate AI into projects.
- 🎯 **Looking** into and experimenting with game development using Unity.

<p align="left">
  I'm currently employed as a Software Engineer at Howden Insurance Services developing and maintaining interactive insurance broking & claim software.
  I've worked primarily in Blazor, constructing accessible & user-driven front-ends, accompanied by clean & maintainable complex back-end logic. My team and I, practice test-driven and trunk-based development to provide rapid deployments with excellent coverage.
...
<p align="left">
  ...
  <a href="https://www.tiktok.com/@smallplasticblokes"> TikTok [Logo Pending]</a>
</p>
...
<strong>I'm building a small indie video game using the Unity engine where everything will be designed and built by me, including characters, levels, music, animation, story etc.</strong>
...
I want to continue to expand Gourm to be a fully fledged cooking assistant with timers, a voice control layer, portion control (e.g. "I'm cooking for 5 people...") and more.

## Off-topic
- ⚔️ **Painting**, reading and watching anything from the Warhammer universe.
- 🌳 **Watering**, repotting and reviving bonsai trees.
- 🎮 **Grinding**, through the World of Warcraft online MMORPG with my wonderful guild <Keepers of Blood> where I operate as an _officer_
